...
#'
#' @param data jsdködv
#' @param weight_recency fjdksöjv
#' @param weight_frequency jfksöfö
#' @param weight_monetary jfaöjöd
#'
#' @return
#' @export
#'
...
#Veröffentlichen auf GIT
git remote add origin
https://github.com/corinnebuergisser/RFM.git
git add .
